...
|violet pen|–|–|–|–|–|
|v-key|–|–|–|–| -          |
|<br/>import header<br/>pe header<br/>pe section header<br/>abc<br/>addrinfo<br/>Some addrinfo routines<br/>big-endiunsigned wyrd<br/>bitmapdata<br/>devmode<br/>docinfo<br/>filetime<br/>gcpresults<br/>gdiplusstartupinput<br/>gprect<br/>in_addr<br/>istream object<br/>istream vtable record<br/>msg<br/>outlinetextmetric<br/>paintstruct<br/>panose<br/>printdlgex<br/>processinfo<br/>rgb<br/>sockaddr<br/>startupinfo<br/>systemtime<br/>talker object<br/>talker vtable record<br/>textmetric<br/>urlcomponents<br/>uuid<br/>win32finddata<br/>window class<br/>wsadata<br/>boroughbox<br/>bucket record<br/>color<br/>date/time<br/>ellipse<br/>email<br/>field term<br/>flag<br/>font<br/>fraction<br/>fraction pair<br/>hcrypthash pointer,<br/>ip address<br/>item<br/>knob<br/>line<br/>logbrush<br/>mixed<br/>number<br/>pair<br/>pdf state<br/>pdf string is string.<br/>pointer<br/>prototype string<br/>rider<br/>selection<br/>string<br/>superduper<br/>term<br/>thing record<br/>timer<br/>url record<br/>vertex array record<br/>wyrd<br/>Some things<br/>bar<br/>compiler<br/>finder<br/>module<br/>mouse<br/>pad<br/>screen<br/>status<br/>|||||            |
