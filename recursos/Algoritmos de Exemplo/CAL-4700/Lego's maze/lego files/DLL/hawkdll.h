...
//		  revision 2.3
//
//	  All copyright PC Control Ltd. 2010-2015
//		
///////////////////////////////////////////////
...
typedef int	(*Type_Sys_GetAn128Count)();			// find number of analogue 128's connected
typedef int	(*Type_Sys_GetDiyHawkCount)();			// find number of DIY hawks connected
...
// analogue 128 defs
typedef int	(*Type_An128_GetAnalogueInputs)(int devnum, int *AnInputs);		// get the current analogue inputs
typedef int	(*Type_An128_SetSensitivities)(int devnum, int Sens1to16,int Sens17to32,int Sens33to48,int Sens49to64,int Sens65to80,int Sens81to96,int Sens97to112,int Sens113to128 );				// set the individual sensitivities required on all inputs
typedef int	(*Type_An128_GetSensitivities)(int devnum, int *Sens1to16,int *Sens17to32,int *Sens33to48,int *Sens49to64,int *Sens65to80,int *Sens81to96,int *Sens97to112,int *Sens113to128 );		// get the individual sensitivities currently set on all inputs

// DIY hawk defs
typedef int	(*Type_Diy_SetOutputs)(int devnum, int outputs);			// set the outputs
typedef int	(*Type_Diy_GetOutputs)(int devnum, int *outputs);			// get the current outputs
typedef int	(*Type_Diy_GetDigitalInputs)(int devnum, int *inputs);		// get the current digital inputs
typedef int	(*Type_Diy_GetAnalogueInputs)(int devnum, int *inputs);		// get the current analogue inputs
